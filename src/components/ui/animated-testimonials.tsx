...
export const AnimatedTestimonials = ({
  ...
  // Replace random rotation with deterministic values based on index
  const getRotationValue = (index: number) => {
    // Use a fixed pattern of rotation values based on index
    const rotationValues = [-8, -5, -3, 0, 3, 5, 8];
